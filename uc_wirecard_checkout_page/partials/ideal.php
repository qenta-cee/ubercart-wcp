...
$a .= '<div id="wcp_ideal_financialInstitution">' . t('Financial institution') . ':</div>';
$a .= '<div id="wcp_ideal_institutions">'.json_encode(WirecardCEE_QPay_PaymentType::getFinancialInstitutions('IDL')).'</div>';
$a .= '</div>';
