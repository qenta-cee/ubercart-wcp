...
$a .= '<div id="wcp_eps_financialInstitution">' . t('Financial institution') . ':</div>';
$a .= '<div id="wcp_eps_institutions">'.json_encode(WirecardCEE_QPay_PaymentType::getFinancialInstitutions('EPS')).'</div>';
$a .= '</div>';
